...
class CarseatGroupModal extends React.Component {
  ...
  onOpened() {
    const {carseatGroup} = this.props;
    const {name} = carseatGroup;
    this.setState({
      name: name || '',
    });
  }
    ...
    return (
      ...
      >
        ...
        <ModalBody>
          <Form>
            <FormGroup>
              <Label>Car Seat Group Name</Label>
...
export default CarseatGroupModal;
